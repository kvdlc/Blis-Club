...
/* ─── Data ─── */
const PAIN_POINTS = [
  { icon: <img src="/icons/problema-sobrepeso-canino.webp" alt="Sobrepeso canino" className="w-6 h-6 object-contain" />, title: "Sobrepeso canino", desc: "El 56% de los perros en Latinoamérica tienen sobrepeso por croquetas procesadas." },
  { icon: <img src="/icons/problema-enfermedades-evitables.webp" alt="Enfermedades evitables" className="w-6 h-6 object-contain" />, title: "Enfermedades evitables", desc: "Diabetes, alergias y problemas renales causados por mala alimentación." },
  { icon: <img src="/icons/problema-falta-ejercicio.webp" alt="Falta de ejercicio" className="w-6 h-6 object-contain" />, title: "Falta de ejercicio", desc: "Paseos sin control que no ejercitan correctamente a tu perro." },
  { icon: <img src="/icons/problema-vet-caro.webp" alt="Vet caro e impredecible" className="w-6 h-6 object-contain" />, title: "Vet caro e impredecible", desc: "Visitas de emergencia que podrían evitarse con prevención." },
];

const SOLUTION_PILLARS = [
  { icon: <img src="/icons/solucion-nutricion-mixta.webp" alt="Nutrición Mixta" className="w-8 h-8 object-contain" />, title: "Nutrición Mixta Inteligente", desc: "150+ recetas personalizadas. Calculadora automática que ajusta la ración según peso, edad y actividad.", color: "from-secondary-400 to-secondary-600" },
  { icon: <img src="/icons/solucion-academia-canina.webp" alt="Academia Canina" className="w-8 h-8 object-contain" />, title: "Academia Canina Pro", desc: "Entrenamiento gamificado estilo Duolingo. Obediencia, agilidad, seguridad y socialización paso a paso.", color: "from-primary-400 to-primary-600" },
  { icon: <img src="/icons/solucion-tracker-salud.webp" alt="Tracker de Salud" className="w-8 h-8 object-contain" />, title: "Tracker de Salud 360°", desc: "Vacunas, peso, visitas, medicamentos y veterinarios. Todo el historial médico en un solo lugar.", color: "from-accent-400 to-accent-600" },
];
...
const EXPANDABLE_FEATURES = [
  {
    icon: <img src="/icons/feature-hasta-4-perros.webp" alt="Hasta 4 perros" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-150-recetas.webp" alt="150+ recetas" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-reto-transicion.webp" alt="Reto de transición" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-academia-canina.webp" alt="Academia canina" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-graficos-avanzados.webp" alt="Gráficos avanzados" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-soporte-prioritario.webp" alt="Soporte prioritario" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-escaner-alimentos.webp" alt="Escáner de alimentos" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-tracker-salud.webp" alt="Tracker de salud" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-mapa-paseos.webp" alt="Mapa de paseos" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-badges-logros.webp" alt="Badges y logros" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-objetivos-personalizados.webp" alt="Objetivos personalizados" className="w-6 h-6 object-contain" />,
  ...
  {
    icon: <img src="/icons/feature-disponible-todos-lados.webp" alt="Disponible en todos lados" className="w-6 h-6 object-contain" />,
...
const SUCCESS_STORIES = [
  {
    ...
    icon: <img src="/icons/historia-obediencia-basica.webp" alt="Obediencia básica" className="w-8 h-8 object-contain" />,
  },
  {
    ...
    icon: <img src="/icons/historia-perro-seguridad.webp" alt="Perro de seguridad" className="w-8 h-8 object-contain" />,
  },
  {
    ...
    icon: <img src="/icons/historia-agilidad-deporte.webp" alt="Agilidad y deporte" className="w-8 h-8 object-contain" />,
  },
  {
    ...
    icon: <img src="/icons/historia-entrenador-primero.webp" alt="Entrenador primero" className="w-8 h-8 object-contain" />,
  },
];
...
const BEFORE_AFTER = [
  { label: "Antes", title: "Alimentación desordenada", desc: "Croquetas procesadas, sobrealimentación por ansiedad, golosinas sin control y un perro con sobrepeso, mal aliento y heces enormes.", bad: true, icon: <img src="/icons/antes-despues-alimentacion-desordenada.webp" alt="Alimentación desordenada" className="w-5 h-5 object-contain" /> },
  { label: "Después", title: "Dieta Mixta estructurada", desc: "Recetas balanceadas con gramos exactos, menús semanales claros y un perro con energía estable, pelaje brillante y digestión perfecta.", bad: false, icon: <img src="/icons/antes-despues-dieta-mixta.webp" alt="Dieta Mixta" className="w-5 h-5 object-contain" /> },
  ...
  { label: "Después", title: "Academia gamificada", desc: "Lecciones diarias progresivas, seguimiento visual de avance, logros desbloqueables y un perro que obedece en casa y en la calle.", bad: false, icon: <img src="/icons/antes-despues-academia-gamificada.webp" alt="Academia gamificada" className="w-5 h-5 object-contain" /> },
  { label: "Antes", title: "Salud reactiva", desc: "Vet solo en emergencias costosas, vacunas olvidadas, historial disperso en papeles y un perro expuesto a enfermedades prevenibles.", bad: true, icon: <img src="/icons/antes-despues-salud-reactiva.webp" alt="Salud reactiva" className="w-5 h-5 object-contain" /> },
  { label: "Después", title: "Salud preventiva", desc: "Recordatorios automáticos, historial completo siempre en el celular, alertas inteligentes y un perro protegido antes de que algo pase.", bad: false, icon: <img src="/icons/antes-despues-salud-preventiva.webp" alt="Salud preventiva" className="w-5 h-5 object-contain" /> },
];
          ...
          {PAIN_POINTS.map((p, i) => (
            <div key={i} className="card-soft rounded-2xl p-5 hover:border-primary-200 dark:hover:border-primary-700 transition-all duration-300">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-danger-50 dark:bg-danger-900/30 flex items-center justify-center shrink-0 text-danger-500">
                  {p.icon}
                </div>
                <div>
          ...
          {BEFORE_AFTER.map((item, i) => (
            <div key={i} className={`rounded-2xl p-5 border transition-all ${
              ...
              <div className="flex items-start gap-3">
                <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${item.bad ? "bg-danger-100 text-danger-500" : "bg-emerald-100 text-emerald-600"}`}>
                  {item.icon}
                </div>
                <div>
              ...
              <div key={i} className="card-soft rounded-2xl overflow-hidden transition-all border border-zinc-100 dark:border-zinc-800">
                <button onClick={() => setOpenFeature(isOpen ? null : i)} className="w-full flex items-center justify-between p-4 text-left">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${isOpen ? "bg-primary-100 dark:bg-primary-900/40 text-primary-600" : "bg-zinc-100 dark:bg-zinc-800 text-zinc-500"}`}>
                      {f.icon}
                    </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={i} className="text-center p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800">
              <div className="w-16 h-16 rounded-2xl bg-primary-50 dark:bg-primary-900/30 flex items-center justify-center text-primary-600 mx-auto mb-4">
                {t.icon}
              </div>
        ...
        <div className="max-w-lg mx-auto text-center relative">
          ...
          <div className="relative rounded-[2rem] p-8 text-white border border-primary-200/50 dark:border-primary-800/30 overflow-hidden" style={{ background: "linear-gradient(135deg, #6b63f3 0%, #8b5cf6 50%, #a855f7 100%)" }}>
            ...
            <div className="relative z-10 space-y-4">
              ...
              <a href={`/guau/web/checkout?plan=${planId}`} className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white py-4 px-8 font-extrabold text-sm shadow-xl transition-all active:scale-[0.98] hover:bg-zinc-50 animate-glow-gold" style={{ color: "#6b63f3" }}>
