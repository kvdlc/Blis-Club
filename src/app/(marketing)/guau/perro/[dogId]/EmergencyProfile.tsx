...
import { MapPin, Phone, AlertTriangle, Heart, MessageCircle, Info, Share2, PawPrint } from "lucide-react";
...
export default function EmergencyProfile({ dog, shareUrl, shortUrl }: Props) {
  ...
  return (
    <div className="min-h-screen bg-app-gradient">
      ...
      {/* Hero */}
      <div className="relative overflow-hidden pt-10 pb-20 px-4 bg-gradient-to-br from-red-500 via-red-600 to-red-800">
        ...
        <div className="max-w-lg mx-auto flex flex-col items-center relative z-10">
          <FadeIn delay={0}>
            <div className="relative">
              <div className="absolute inset-0 rounded-full blur-xl opacity-40 bg-red-400" style={{ transform: "scale(1.15)" }} />
        ...
        <svg viewBox="0 0 1440 120" className="absolute bottom-0 left-0 w-full" preserveAspectRatio="none" style={{ height: 60 }}>
          <path d="M0,60 C360,120 720,0 1080,60 C1260,90 1380,80 1440,60 L1440,120 L0,120 Z" fill="#fef2f2" />
        </svg>
      </div>

      {/* Content */}
      <div className="max-w-lg mx-auto px-4 -mt-4 space-y-4 relative z-10 pb-12 bg-red-50/30">
            ...
            <FadeIn delay={400}>
              <div className="group card-elevated rounded-2xl p-5 border-l-[5px] border-primary-400 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-[10px] font-bold text-primary-500 uppercase tracking-wider mb-1">Notas / Señas particulares</p>
        ...
        <FadeIn delay={800}>
          <div className="card-elevated rounded-2xl p-5 space-y-3">
            <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">¿Lo viste?</p>
            <a
        ...
        <FadeIn delay={1000}>
          <div className="text-center pt-4 pb-6">
            <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/80 backdrop-blur-sm border border-primary-100 shadow-sm">
