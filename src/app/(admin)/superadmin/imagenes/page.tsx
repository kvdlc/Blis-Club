      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Gestiona recursos visuales y assets</p>
          </div>
          <button
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="card-soft rounded-[1.25rem] p-6">
              <h2 className="text-base font-bold text-zinc-800 dark:text-zinc-200 mb-4">Galería de Imágenes</h2>
              <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                {Array.from({ length: 6 }).map((_, i) => (
                  <div key={i} className="aspect-square rounded-2xl bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center">
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-4 text-center">
                Próximamente: subida masiva, organización por carpetas y optimización automática.
              </p>
            </div>
          </>
        )}
