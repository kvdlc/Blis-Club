...
const severityBadge = (s: string) => {
  switch (s) {
    case "bajo": return "bg-secondary-100 text-secondary-700";
    case "medio": return "bg-accent-100 text-accent-700";
    case "alto": return "bg-warning-100 text-warning-700";
    case "mortal": return "bg-danger-100 text-danger-700";
    ...
    <AdminGuard>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-extrabold text-zinc-900">Vacunas</h1>
            <p className="text-sm text-zinc-500 mt-1">Gestiona el calendario de vacunación</p>
          </div>
          <button
            onClick={startNew}
        ...
        {(showNew || editing) && (
          <div className="card-soft rounded-[1.25rem] p-6 space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-zinc-600 mb-1.5">Grupo</label>
                <input
              ...
              <div>
                <label className="block text-sm font-semibold text-zinc-600 mb-1.5">Tipo de Vacuna</label>
                <select
              ...
              <div>
                <label className="block text-sm font-semibold text-zinc-600 mb-1.5">Severidad</label>
                <select
                  value={form.severity}
              ...
              <div>
                <label className="block text-sm font-semibold text-zinc-600 mb-1.5">Tipo de Contagio</label>
                <input
              ...
              <div>
                <label className="block text-sm font-semibold text-zinc-600 mb-1.5">Número de Dosis</label>
                <input
                  type="number"
                  min={1}
          ...
          <div className="grid gap-4">
            {vaccines.map((v) => (
              <div key={v.id} className="card-soft rounded-[1.25rem] p-5 flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-danger-100 flex items-center justify-center text-danger-600 shrink-0">
                  <Syringe className="w-6 h-6" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-base font-bold text-zinc-800">{v.name}</p>
