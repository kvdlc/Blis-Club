  ...
  return (
    <>
      <button
        ...
        className="w-full card-soft rounded-2xl p-5 border-red-200 hover:border-red-300 transition-all group"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center">
          ...
          <div className="relative bg-white rounded-t-3xl md:rounded-3xl w-full max-w-md max-h-[90vh] overflow-y-auto p-6 space-y-5 shadow-2xl">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2.5 text-sm text-zinc-800 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500/40"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="mt-1 w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2.5 text-sm text-zinc-800 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500/40 resize-none"
              />
            </div>
