    ...
    <div className="space-y-4">
      ...
      <div className="glass-card border border-white/10 shadow-sm rounded-2xl p-4 space-y-3">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg glass-input flex items-center justify-center">
        ...
        <div className="flex items-center gap-1.5">
          <input type="number" min="100" max="500" value={original.ancho}
            ...
            className="w-full px-2.5 py-2.5 rounded-xl border border-white/10 glass-card text-sm font-bold text-center focus:outline-none focus:ring-2 focus:ring-auto-600/20" />
      ...
      {resultados ? (
        <div className="space-y-3">
          ...
          <div className="glass-card border border-white/10 shadow-sm rounded-2xl p-4">
            ...
            <div className="flex items-end justify-center gap-8">
              ...
              <div className="flex flex-col items-center gap-2">
                <div
                  className="rounded-full border-4 border-white/10 glass-input flex items-center justify-center"
                  style={{
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="glass-card border border-white/10 shadow-sm rounded-xl p-3">
