      ...
      {resultados ? (
        <div className="space-y-3">
          ...
          <div className="bg-zinc-900 border border-white/10 shadow-sm rounded-2xl p-4">
            ...
            <div className="flex items-end justify-center gap-8">
              ...
              <div className="flex flex-col items-center gap-2">
                <div
                  className="rounded-full border-4 border-white/10 bg-zinc-800 flex items-center justify-center"
                  style={{
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-zinc-900 border border-white/10 shadow-sm rounded-xl p-3">
