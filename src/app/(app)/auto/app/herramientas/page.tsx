...
const tools = [
  // Row 1: Two big cards
  { slug: "costo-viaje", icon: Route, label: "Costo de viaje", desc: "Estima combustible + peajes para una ruta", size: "large", color: "bg-amber-500/10 border-amber-500/20 text-amber-400" },
  { slug: "rendimiento", icon: Gauge, label: "Comparador de combustible", desc: "Qué octanaje rinde más por tu dinero", size: "large", color: "bg-teal-500/10 border-teal-500/20 text-teal-400" },
  // Row 2: One wide card + two small
  { slug: "autonomia", icon: Fuel, label: "Autonomía del tanque", desc: "Cuántos km recorres con tanque lleno", size: "wide", color: "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" },
  ...
  { slug: "financiamiento", icon: CreditCard, label: "Financiamiento", desc: "Calcula la cuota mensual de tu préstamo", size: "small", color: "bg-blue-500/10 border-blue-500/20 text-blue-400" },
];
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <ArrowRight className="w-4 h-4 text-zinc-400 group-hover:text-zinc-500 transition-colors" />
              </div>
              <div>
