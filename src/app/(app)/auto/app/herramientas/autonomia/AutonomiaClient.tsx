...
export default function AutonomiaClient({ defaults }: { defaults: Defaults }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <h1 className="text-xl font-extrabold text-zinc-200">Autonomía del Tanque</h1>
      ...
      <div className="glass-card border border-white/10 shadow-sm rounded-2xl p-4 space-y-3">
        ...
        <label className="block">
          ...
          <input type="number" min="1" step="0.1" value={rendimiento}
            ...
            className="w-full mt-1 px-3 py-2.5 rounded-xl border border-white/10 glass-card text-sm font-medium focus:outline-none focus:ring-2 focus:ring-auto-600/20 disabled:bg-zinc-800" />
        </label>
      </div>
      ...
      {resultados ? (
        <div className="space-y-3">
          ...
          <div className="glass-card border border-white/10 shadow-sm rounded-2xl p-4">
            <h3 className="text-xs font-extrabold text-zinc-300 mb-3">¿Hasta dónde llegas?</h3>
              ...
              {resultados.viajes.map((v) => {
                ...
                return (
                  <div key={v.nombre} className="flex items-center gap-2">
                    ...
                    <div className="flex-1 h-4 glass-input rounded-full overflow-hidden">
