      ...
      <div className="bg-zinc-900 border border-white/10 shadow-sm rounded-2xl p-4 space-y-3">
        ...
        <label className="block">
          ...
          <input type="number" min="1" step="0.1" value={rendimiento}
            ...
            className="w-full mt-1 px-3 py-2.5 rounded-xl border border-white/10 bg-zinc-900 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-auto-600/20 disabled:bg-zinc-800" />
        </label>
      </div>
