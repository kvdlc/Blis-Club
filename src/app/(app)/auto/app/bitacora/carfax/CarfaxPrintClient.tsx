...
export default function CarfaxPrintClient({ vehicle, fuelLogs, maintenances, upgrades, specs }: Props) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white text-zinc-800 print:p-4 print:text-xs">
      {/* Solo mostrar en pantalla, ocultar al imprimir */}
      <div className="print:hidden mb-4 p-3 rounded-xl bg-auto-50 border border-auto-200 text-center">
        <p className="text-sm font-bold text-auto-700">⏳ Abriendo ventana de impresión...</p>
      ...
      <div className="text-center mb-6 pb-4 border-b-2 border-zinc-200">
        <h1 className="text-2xl font-black text-auto-700 print:text-xl">Reporte Carfax</h1>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-2 bg-zinc-50 rounded-xl p-4 print:p-3">
      ...
      <div className="mb-6">
        ...
        {fuelLogs.length === 0 ? (
          ...
          <div className="bg-zinc-50 rounded-xl overflow-hidden print:text-[9px]">
      ...
      <div className="mb-6">
        ...
        <div className="bg-zinc-50 rounded-xl p-4 print:p-3 space-y-2">
      ...
      {/* Footer */}
      <div className="text-center text-[10px] text-zinc-400 mt-8 pt-4 border-t border-zinc-200">
...
function Row({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between py-1 px-2 rounded-lg print:py-0.5">
      <span className="text-[10px] text-zinc-400 print:text-[8px]">{label}</span>
...
function SummaryRow({ label, value, bold }: { label: string; value: string; bold?: boolean }) {
  return (
    <div className="flex items-center justify-between">
      <span className={`${bold ? "text-sm font-extrabold text-zinc-800" : "text-xs text-zinc-600"}`}>{label}</span>
      <span className={`${bold ? "text-lg font-black text-auto-600" : "text-sm font-bold text-zinc-800"}`}>{value}</span>
    </div>
  );
}
