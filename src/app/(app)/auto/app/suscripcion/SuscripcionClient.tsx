  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-3">
        ...
        <h1 className="text-3xl font-extrabold text-zinc-200">Blis Auto Pro</h1>
      ...
      {planes.length > 0 && (
        <div className="flex items-center justify-center gap-3">
          <span className={`text-xs font-bold ${!isAnnual ? "text-zinc-200" : "text-zinc-500"}`}>Mensual</span>
          <button
      ...
      <div className="space-y-3">
        {planes.map((plan) => (
          <div key={plan.id} className="card-auto-dark rounded-2xl p-4">
