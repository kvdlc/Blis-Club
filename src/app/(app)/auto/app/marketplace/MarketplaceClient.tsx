    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <button onClick={handleSearch}
          className="px-4 py-2.5 rounded-xl bg-zinc-800 text-zinc-500 text-sm font-bold hover:bg-zinc-800 transition-colors">
          Buscar
        </button>
      </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {listings.map((listing) => (
            <Link
              ...
              className="bg-zinc-900 border border-white/10 shadow-sm rounded-2xl overflow-hidden hover:shadow-md transition-shadow group"
            >
              {/* Imagen */}
              ...
              <div className="p-3 space-y-1.5">
                ...
                <div className="flex items-center gap-1.5">
                  <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded-full ${
                    listing.estado_item === "nuevo" ? "bg-emerald-500/10 text-emerald-400" : "bg-zinc-800 text-zinc-500"
                  }`}>
