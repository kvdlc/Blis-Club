    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">{listings.length} publicaciones</p>
          </div>
        </div>
        <Link
      ...
      <div className="flex gap-2">
        ...
        <button onClick={handleSearch}
          className="px-4 py-2.5 rounded-xl bg-white/5 text-zinc-400 text-sm font-bold hover:bg-white/10 transition-colors">
          Buscar
        </button>
      </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {listings.map((listing) => (
            <Link
              ...
              className="card-auto-dark rounded-2xl overflow-hidden hover:shadow-md transition-shadow group"
            >
              {/* Imagen */}
