      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <label className="block">
          ...
          <textarea rows={3} value={form.descripcion} onChange={(e) => setForm({ ...form, descripcion: e.target.value })}
            ...
            className="w-full mt-1 px-3 py-2.5 rounded-xl border border-zinc-200 bg-zinc-100 text-sm focus:outline-none focus:ring-2 focus:ring-auto-600/20 resize-none" />
        </label>
        ...
        <div>
          ...
          <div className="flex gap-1.5 mt-1">
            <input value={fotoUrl} onChange={(e) => setFotoUrl(e.target.value)}
              ...
              placeholder="https://..."
              className="flex-1 px-3 py-2.5 rounded-xl border border-zinc-200 bg-zinc-100 text-xs focus:outline-none focus:ring-2 focus:ring-auto-600/20" />
            <button type="button" onClick={addFoto} disabled={!fotoUrl.trim() || form.fotos.length >= 5}
              className="px-3 py-2.5 rounded-xl bg-zinc-100 text-zinc-500 hover:bg-auto-100 hover:text-auto-500 disabled:opacity-40 transition-colors">
