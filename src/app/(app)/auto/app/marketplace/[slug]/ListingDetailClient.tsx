...
export default function ListingDetailClient({ listing }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Detalles */}
      <div className="bg-zinc-900 border border-white/10 shadow-sm rounded-2xl p-4 grid grid-cols-2 gap-3">
        {listing.ciudad && (
          <div>
      ...
      {whatsappUrl ? (
        ...
        <div className="w-full py-3.5 rounded-2xl bg-zinc-800 text-zinc-500 text-sm font-bold text-center">
