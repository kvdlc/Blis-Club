    ...
    <main className="max-w-3xl mx-auto px-4 pt-8 space-y-4 pb-8">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">1. Responsable del tratamiento</h2>
        </div>
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">2. Datos que recolectamos</h2>
        </div>
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">3. Bases legales</h2>
        </div>
        <p className="text-sm text-zinc-600 leading-relaxed">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">4. Terceros y procesadores</h2>
        </div>
        <ul className="list-disc list-inside text-sm text-zinc-600 leading-relaxed space-y-1">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">5. Derechos ARCO</h2>
        </div>
        <p className="text-sm text-zinc-600 leading-relaxed">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">6. Seguridad de la informacion</h2>
        </div>
        <p className="text-sm text-zinc-600 leading-relaxed">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">7. Contacto</h2>
        </div>
        <p className="text-sm text-zinc-600 leading-relaxed">
