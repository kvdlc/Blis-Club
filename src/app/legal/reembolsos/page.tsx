    ...
    <main className="max-w-3xl mx-auto px-4 pt-8 space-y-4 pb-8">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">1. Garantia de 14 dias</h2>
        </div>
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">2. Casos que no aplican</h2>
        </div>
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">3. Como solicitar un reembolso</h2>
        </div>
        <ol className="list-decimal list-inside text-sm text-zinc-600 leading-relaxed space-y-1">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">4. Metodo y plazo de reembolso</h2>
        </div>
        <p className="text-sm text-zinc-600 leading-relaxed">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">5. Cancelacion de suscripcion</h2>
        </div>
        <p className="text-sm text-zinc-600 leading-relaxed">
      ...
      <section className="bg-white rounded-[1.25rem] p-5 space-y-3 border border-zinc-100">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900">6. Excepciones</h2>
        </div>
        <p className="text-sm text-zinc-600 leading-relaxed">
