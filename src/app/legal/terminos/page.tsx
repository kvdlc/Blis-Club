    ...
    <main className="max-w-3xl mx-auto px-4 pt-8 space-y-4 pb-8">
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-[1.25rem] p-5 space-y-3 border border-zinc-100 dark:border-zinc-800">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">1. Descripcion del servicio</h2>
        </div>
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-[1.25rem] p-5 space-y-3 border border-zinc-100 dark:border-zinc-800">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">2. Precios y pagos</h2>
        </div>
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-[1.25rem] p-5 space-y-3 border border-zinc-100 dark:border-zinc-800">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">3. Garantia de devolucion</h2>
        </div>
        <p className="text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-[1.25rem] p-5 space-y-3 border border-zinc-100 dark:border-zinc-800">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">4. Cancelacion y acceso</h2>
        </div>
        <p className="text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-[1.25rem] p-5 space-y-3 border border-zinc-100 dark:border-zinc-800">
        <div className="flex items-center gap-2">
          <FileText className="w-5 h-5 text-primary-600" />
          <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">5. Contenido digital</h2>
        </div>
        <p className="text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-[1.25rem] p-5 space-y-3 border border-zinc-100 dark:border-zinc-800">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">6. Jurisdiccion</h2>
        </div>
        <p className="text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
      ...
      <section className="bg-white dark:bg-zinc-900 rounded-[1.25rem] p-5 space-y-3 border border-zinc-100 dark:border-zinc-800">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">7. Contacto legal</h2>
        </div>
        <p className="text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
