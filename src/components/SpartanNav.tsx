...
import { Shield, Dumbbell, Flame, CheckSquare, User } from "lucide-react";

type TabKey = "motivacion" | "gimnasio" | "inicio" | "habitos" | "perfil";

const tabRoutes: Record<TabKey, string> = {
  motivacion: "/Spartan/app/motivacion",
  gimnasio: "/Spartan/app/gimnasio",
  inicio: "/Spartan/app",
  habitos: "/Spartan/app/habitos",
  perfil: "/Spartan/app/perfil",
};

function inferTabFromPathname(pathname: string): TabKey {
  if (pathname.startsWith("/Spartan/app/motivacion")) return "motivacion";
  if (pathname.startsWith("/Spartan/app/gimnasio")) return "gimnasio";
  if (pathname.startsWith("/Spartan/app/habitos")) return "habitos";
  if (pathname.startsWith("/Spartan/app/perfil")) return "perfil";
  return "inicio";
}

const desktopTabs: { key: TabKey; icon: any; label: string }[] = [
  { key: "motivacion", icon: Flame, label: "Motivación" },
  { key: "gimnasio", icon: Dumbbell, label: "Gimnasio" },
  { key: "inicio", icon: Shield, label: "Inicio" },
  { key: "habitos", icon: CheckSquare, label: "Hábitos" },
  { key: "perfil", icon: User, label: "Perfil" },
];

const mobileTabs: { key: TabKey; icon: any; label: string; center?: boolean }[] = [
  { key: "motivacion", icon: Flame, label: "Motiv." },
  { key: "gimnasio", icon: Dumbbell, label: "Gym" },
  { key: "inicio", icon: Shield, label: "Inicio", center: true },
  { key: "habitos", icon: CheckSquare, label: "Hábitos" },
  { key: "perfil", icon: User, label: "Perfil" },
];

export default function SpartanNav() {
