          ...
          {mobileTabs.map((tab) => {
            ...
            if (tab.center) {
              return (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-auto-600 text-white flex items-center justify-center shadow-auto-glow border-4 border-black transition-transform active:scale-95">
